 ...
 * as needed.
 */
public class MatrixCursorCompat extends AbstractCursor {
     ...
     */
    public MatrixCursorCompat(String[] columnNames, int initialCapacity) {
    ...
    private Object get(int column) {
        ...
        return data[getPosition() * columnCount + column];
    }
    ...
    public int getType(int column) {
        return DatabaseUtilsCompat.getTypeOfObject(get(column));
    }
